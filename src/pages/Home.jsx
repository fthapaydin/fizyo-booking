...
export default function Home({ clinic, onSelectClinic, onDirectCalendar }) {
  ...
  return (
    <div className="min-h-screen bg-[#fafcfb] text-slate-800 font-[Inter] antialiased flex flex-col justify-between">
      ...
      {/* ─── 1. NAVBAR ────────────────────────────────────────── */}
      <nav className="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-gray-200/80 shadow-xs">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div className="truncate max-w-[160px] sm:max-w-xs">
              <span className="text-[14px] sm:text-[15px] font-extrabold text-gray-900 tracking-tight block truncate">
          ...
          <div className="flex items-center gap-2">
            {isSpecificClinicMode ? (
              <button
                ...
                className="h-9 px-4 bg-gradient-to-r from-teal-600 to-emerald-500 text-white rounded-xl text-[12px] sm:text-[13px] font-semibold hover:from-teal-700 hover:to-emerald-600 transition-all shadow-md shadow-teal-200 cursor-pointer shrink-0"
              >
                Randevu Al
              </button>
            ) : (
              <>
                <button
                  ...
                  className="inline-flex items-center gap-1.5 h-9 px-3 rounded-xl text-[12px] font-semibold text-gray-700 hover:bg-gray-100 transition-colors cursor-pointer"
                >
                  <Search size={14} className="text-teal-600" />
                  <span className="hidden sm:inline">Klinik Ara</span>
                </button>
                <button
                  onClick={() => scrollToSection('pricing-section')}
                  className="hidden md:inline-flex items-center gap-1.5 h-9 px-3 rounded-xl text-[12px] font-semibold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 transition-colors cursor-pointer"
                >
                  <Tag size={13} />
                  <span>Fiyatlar</span>
                </button>
                <a
                  ...
                  className="h-9 px-3.5 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-[11px] sm:text-[12px] font-semibold transition-all shadow-sm flex items-center gap-1.5 shrink-0"
                >
      ...
      <main className="flex-1">
        {/* ─── 2. HERO SECTION ──────────────────────────────────── */}
        <section className="relative overflow-hidden pt-12 pb-12 sm:pt-16 sm:pb-16 border-b border-gray-100 bg-gradient-to-b from-teal-50/50 via-white to-slate-50/60">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
            ...
            <div className="inline-flex items-center gap-2 bg-emerald-50 border border-emerald-200/80 rounded-full px-3.5 py-1.5 mb-5 shadow-2xs max-w-full">
              ...
              <span className="text-[11px] sm:text-[12px] font-bold text-emerald-800 truncate">
                {isSpecificClinicMode ? `${clinic.name} • Canlı Randevu Takvimi` : 'Türkiye Geneli 81 İlde Fizyoterapi Randevusu'}
              </span>
            </div>
            ...
            <p className="text-[14px] sm:text-[16px] text-gray-500 max-w-2xl mx-auto mb-8 leading-relaxed font-normal px-2">
              {isSpecificClinicMode
            ...
            {isSpecificClinicMode ? (
              <div className="flex items-center justify-center gap-3">
                <button
                  onClick={onDirectCalendar}
                  className="h-12 px-7 sm:px-8 bg-gradient-to-r from-teal-600 to-emerald-500 text-white rounded-2xl text-[14px] sm:text-[15px] font-bold hover:from-teal-700 hover:to-emerald-600 transition-all shadow-xl shadow-teal-200 cursor-pointer inline-flex items-center gap-2"
                >
            ...
            {/* Trust Badges */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-3xl mx-auto mt-10 pt-8 border-t border-gray-200/60 text-left">
        ...
        <section id="how-it-works" className="max-w-5xl mx-auto px-4 sm:px-6 py-14 sm:py-20 scroll-mt-28">
          <div className="text-center max-w-xl mx-auto mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 mt-2.5 mb-2">
        ...
        <section className="bg-slate-50/80 border-y border-gray-100 py-14 sm:py-16">
        ...
        <section id="search-section" className="max-w-5xl mx-auto px-4 sm:px-6 pb-16 pt-4 scroll-mt-28">
          <div className="bg-white rounded-3xl border border-gray-200/90 p-5 sm:p-7 md:p-8 shadow-xl shadow-slate-200/50">
            <div className="flex items-center gap-2 mb-4 pb-3 border-b border-gray-100">
              ...
              <h2 className="text-[16px] sm:text-[17px] font-bold text-gray-800">Şehir &amp; İlçe Seçerek Klinik Bul (A-Z Alfabetik)</h2>
            </div>
              ...
              {loadingClinics ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {filteredClinics.map((item) => (
                    <div
                      key={item.id}
                      className="p-5 rounded-2xl border border-gray-200/80 bg-white hover:border-teal-300 hover:shadow-md transition-all flex flex-col justify-between gap-4"
                    >
                      <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto items-stretch">
              ...
              <div className="bg-white rounded-3xl border border-gray-200 p-8 shadow-sm hover:shadow-md transition-all flex flex-col justify-between relative">
                ...
                <a
                  ...
                  className="w-full h-12 rounded-2xl bg-gray-900 hover:bg-gray-800 text-white font-bold text-[14px] flex items-center justify-center gap-2 transition-all shadow-sm"
                >
              ...
              {/* Plan 2: Yıllık Kampanyalı (Öne Çıkan) */}
              <div className="bg-gradient-to-b from-slate-900 to-indigo-950 text-white rounded-3xl border-2 border-indigo-500/50 p-8 shadow-2xl hover:shadow-indigo-500/20 transition-all flex flex-col justify-between relative overflow-hidden">
                ...
                <a
                  ...
                  className="w-full h-12 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-400 hover:from-emerald-400 hover:to-teal-300 text-slate-950 font-black text-[14px] flex items-center justify-center gap-2 transition-all shadow-lg shadow-emerald-500/20"
                >
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <a
                ...
                className="w-full sm:w-auto h-11 px-6 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-[13px] font-bold flex items-center justify-center gap-2 shadow-lg shadow-emerald-950/50 transition-all"
              >
                <Mail size={15} />
              ...
              <a
                ...
                className="w-full sm:w-auto h-11 px-5 rounded-xl border border-slate-700 bg-slate-900/60 hover:bg-slate-800 text-slate-200 text-[13px] font-semibold transition-all flex items-center justify-center gap-1.5"
              >
